...
export default function Input({tipoInp, label, htmlFor, placeholder, classe = '', value, funcao, maxlength, checado, opcoeslabel, opcoes, disabled=false, minLength, mask}) {
    ...
    if (classe == 'metade') {
        ...
        return (
            <div className={"d-inline-block my-3 " + css.metade}>
                ...
                <input type={tipoInp} placeholder={placeholder} id={htmlFor} name={htmlFor} className={"d-block w-100 rounded px-2 py-1 " + css.input} value={valorParaExibir} onChange={funcao} required/>
            </div>
        )
