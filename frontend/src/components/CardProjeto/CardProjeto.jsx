...
export default function CardProjeto({NomeProjeto, id}) {
    return (
        <div className={'row w-75 m-auto bg-light p-2 rounded-2 shadow-sm my-3 flex-column flex-sm-row text-center text-sm-start'}>
            <div className={'col-sm-6 col-12 mb-4 mb-sm-0'}>
                <h5>{NomeProjeto}</h5>
            </div>
            <div className={'col d-flex justify-content-evenly flex-sm-row flex-column gap-3'}>
                <Buton tamanho={'pequeno'} texto={'Fazer post'} background={'rosa'} rota={'/adicionar_post'}/>
