...
export default function PaginaCadastro() {
    ...
    async function cadastro(f) {
        ...
        let retorno = await fetch(`http://10.92.3.230:5000/cadastro`, {
            method: "POST",
            credentials: "include",
            body: form
        })
            ...
            <div className="row">
                <div className="col">
                    <Form largura="maior" titulo={"Cadastro"} onSubmit={cadastro}>
                        ...
                        <Input htmlFor={'telefone'} label={'Telefone'} tipoInp={'tel'}  placeholder={'Digite seu telefone'} value={telefone} funcao={(f) => setTefone(f.target.value)}/>
                        ...
                        {selecionado == "0" ? (
                            ...
                            <>
                                ...
                                <div className="w-100 d-flex justify-content-center align-items-center">
                                    <UploadImagem textoUpload={'Fazer upload da logo da ONG'} value={imagem} funcao={(f) => setImagem(f.target.files[0])} />
                                </div>
