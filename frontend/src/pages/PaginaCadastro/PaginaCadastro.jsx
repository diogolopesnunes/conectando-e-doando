                ...
                <div className="row">
                    <div className="col">
                        ...
                        <Form largura="maior" titulo={"Cadastro"} onSubmit={cadastro}>
                            <Input obrigatorio={"Sim"} htmlFor={'nome'} label={'Nome'} tipoInp={'text'} placeholder={'Digite seu nome'} value={nome} funcao={(f)=> setNome(f.target.value)}/>
                            <Input obrigatorio={"Sim"} htmlFor={'email'} label={'Email'} tipoInp={'email'} placeholder={'Digite seu email'} value={email} funcao={(f)=> setEmail(f.target.value)}/>
                            <div className={"w-75 m-auto d-flex justify-content-between " + css.senha}>
                                <Input obrigatorio={"Sim"} minLength={8} maxLength={20} htmlFor={'senha'} label={'Senha'} tipoInp={'password'}
                                       placeholder={'Digite sua senha'} classe={'metade'} value={senha} funcao={(f) => setSenha(f.target.value)}/>
                                <Input obrigatorio={"Sim"} minLength={8} maxLength={20} htmlFor={'confirmarSenha'} label={'Confirme sua senha'} tipoInp={'password'}
                            ...
                            <Input obrigatorio={"Sim"} htmlFor={'telefone'} label={'Telefone'} tipoInp={'text'}  placeholder={'Digite seu telefone'} value={telefone} funcao={(e) => setTelefone(e.target.value.replace(/\D/g, "").slice(0, 11))}
                                   inputMode="numeric"
                                   maxLength={15}
                                   minLength={15}
                                   mask={"telefone"}/>
