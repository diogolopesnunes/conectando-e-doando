                    ...
                    <Form titulo={"Cadastro"}>
                        ...
                        {selecionado === "doador" ? (
                            ...
                            <>
                                ...
                                <Input htmlFor={'cidade'} label={'Cidade:'} tipoInp={'text'} placeholder={'Digite a cidade da ONG'}/>
                                <Input htmlFor={'banco'} label={'Banco:'} tipoInp={'text'} placeholder={'Informe qual seu banco'}/>
                                <Input htmlFor={'agencia'} label={'Agencia:'} tipoInp={'text'} placeholder={'Informe a agencia bancária'}/>
                                <Input htmlFor={'conta'} label={'Conta:'} tipoInp={'text'} placeholder={'Informe a conta bancária'}/>
